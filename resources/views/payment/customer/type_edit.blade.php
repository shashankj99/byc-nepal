...
@section("content")
    ...
    <div class="row mb-3">
        <div class="col">
            <h6>
                would you like to update the selected payment type for your 240 litre wheelie-bin?
            </h6>
        </div>
    </div>
    <form action="{{ route("customer.payment.type.update", $pre_order->id) }}" method="POST">
        @csrf
        {{ method_field("PUT") }}
                        ...
                        <div class="card-body ml-2" role="button">
                            <h5 class="card-title">
                                <input class="form-check-input" id="full"
                                       ...
                                       value="full"
                                       @if($pre_order->payment_type == "full") checked @endif
                                       required>
                        ...
                        <div class="card-body ml-2" role="button">
                            <h5 class="card-title">
                                <input class="form-check-input" id="installment"
                                       type="radio" name="payment_type"
                                       value="installment"
                                       @if($pre_order->payment_type == "installment") checked @endif
                                       required>
                                <label class="form-check-label mt-1">
